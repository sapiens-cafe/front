...
export const Featured = ({ products, locale }: { products: Product[]; locale: string }) => {
  const productsSorted = products.sort((a, b) =>
    a.datetime && b.datetime && a.datetime > b.datetime ? 1 : -1
  );
  return (
    <div className="py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3  gap-10">
        <div className="md:col-span-2">
          ...
          <div className="mt-4">
            {dayjs(productsSorted[0]?.datetime).isAfter(dayjs()) && (
              <EventSubscriberModal productId={productsSorted[0].documentId} />
            )}
          </div>
        </div>
